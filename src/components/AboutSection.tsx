  ...
  <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-4 xl:grid-rows-3 gap-4 sm:gap-6 lg:gap-8">
    ...
    />
        ...
        <div className="mt-16 
                        md:mt-20 
                        md:-ml-2 
                        md:pl-0 h-full w-full flex flex-col items-start justify-center pb-3 sm:pb-7">
          <h2 className="text-lg md:text-xm lg:text-xl  font-bold  md:mb-1 text-black mb-1 pt-5 md:pt-15">Оборудование</h2>
    ...
    <AnimatedCard delay="0.15s" className="col-span-1 md:col-span-3 row-span-1">
      <div className="group relative h-full min-h-[200px] md:min-h-[300px] rounded-3xl p-4 md:p-6 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] bg-primary overflow-hidden">
        <div className="flex flex-col md:flex-row items-start md:items-center h-full">
          ...
          <div className="mt-2 absolute top-20  -left-100
                  md:top-30 md:-left-1 
                  lg:top-30 lg:-left-1 
                  xl:top-30 xl:-left-80 
                  2xl:top-30 2xl:-left-80 
                  w-260 h-40  
                  md:w-220 md:h-65 
                  lg:w-275 lg:h-56 
                  xl:w-300 xl:h-64 
    ...
    <AnimatedCard delay="0.25s" className="col-span-1 md:col-span-3 row-span-1">
      <div className="group relative h-full min-h-[200px] md:min-h-[300px] rounded-3xl p-4 md:p-6 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] overflow-hidden bg-primary">
        <div className="flex flex-col md:flex-row items-start md:items-center h-full">
          ...
          <div className="mt-2 absolute top-20 -right-100
    ...
    />
        ...
        {/* Контент */}
         <div className="mt-16 md:mt-20 md:-ml-2 md:pl-0 h-full w-full flex flex-col items-start justify-center  sm:pb-5">
          <h2 className="text-lg md:text-xm lg:text-xl  font-bold  md:mb-1 text-black mb-1 pt-5 md:pt-15">Мы №1</h2>
          <p className="text-black text-xs md:text-sm">
    ...
    />
        ...
        {/* Контент */}
        <div className="mt-16 md:mt-20 md:-ml-2 md:pl-0 h-full w-full flex flex-col items-start justify-center sm:pb-5">
          <h2 className="text-lg md:text-xm lg:text-xl  font-bold  md:mb-1 text-black mb-1 pt-5 md:pt-15">Скорость</h2>
          <p className="text-black text-xs md:text-sm ">
